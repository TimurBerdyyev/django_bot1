...
HELP_TEXT = """
Привет, я бот!Я помогу тебев поиске различных рецептов! У нас есть такие команды как:

<b>Помощь ⭐️</b> - помощь по командам бота
<b>Описание 📌</> - адрес, контактные данные, график работы
<b>Каталог 🛒</b> - список рецептов которые можно посмотреть
...
async def cmd_start(message: types.Message):
    try:
        await bot.send_message(chat_id=message.chat.id,
                               text="Привет, я бот!Я помогу тебев поиске различных рецептов!\n\n"
                                    "У меня вы можете посмотреть  все что захотите, чтобы увидеть список "
                                    "рецептов которые у меня есть.\n\n"
...
async def cmd_description(message: types.Message):
    await bot.send_message(chat_id=message.chat.id,
                           text="Привет, "
                                ...
                                "наш сервис , мы работает с Понедельника до "
                                "Пятницы.\n9:00 - 21:00")
